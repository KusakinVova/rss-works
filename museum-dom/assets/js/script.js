...
console.log('%c'+ 'По дружески прошу проверить мою работу после 5ти часов дня 🙏 🙏 🙏', 'color: #008000; font-size: 18px')
console.log('%c'+ 'Просто я из-за работы не успеваю сделать до дедлайна.', 'color: #008000; font-size: 18px');
...
console.log('%c'+ ' ', 'color: #008000; font-size: 18px');
...
console.log('+   10 Любой собственный дополнительный функционал (+10)');
